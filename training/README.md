...
`--smoke` uses a seeded hand-coded tactical baseline and does not need Kaggle or a trained artifact. It still needs NumPy and Gymnasium. PPO training is:
